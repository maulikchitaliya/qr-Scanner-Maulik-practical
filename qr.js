...
// /* ============================================================
//    CODE 39 CAMERA BARCODE SCANNER
//    ============================================================ */
...
//         const lastNotice =
//             duplicateNoticeAt.get(value) || 0;


//         if (
//             now - lastNotice >=
//             DUPLICATE_NOTICE_COOLDOWN
//         ) {

//             duplicateNoticeAt.set(
//                 value,
//                 now
//             );

//             showErrorToast(
//                 "Already scanned: " + value
//             );
...
//          * This helps when barcode is kept farther
...
//         /*
//          * Try camera optical/digital zoom
//          * if browser exposes it.
//          */
...
//         /*
//          * If zoom is supported, use moderate zoom.
//          *
//          * We don't use maximum zoom because maximum
//          * zoom can make barcode unstable.
//          */
...
//          * if camera doesn't support it.
//          */

//         console.debug(
//             "Camera zoom unavailable"
//         );
//     }
// }
...
//         setStatus(
//             "Scanning Code 39 (fallback)..."
//         );
//     }


//     /*
//      * Always keep fallback active.
//      */
...
// /* ============================================================
//    CODE 39 CHARACTER DECODER
//    ============================================================ */

// function code39CharError(
//     runs,
//     expected
// ) {
...
//         /*
//          * Prevent random noise
//          * from becoming barcode.
//          */
...
//     /*
//      * Many horizontal scan
//      * positions.
//      *
//      * This helps when barcode
...
//     /*
//      * First try complete camera image.
//      */
...
//     /*
//      * EXTRA FAR-BARCODE RECOVERY
//      *
//      * Crop the center of the camera
//      * and enlarge it 2x.
//      */
